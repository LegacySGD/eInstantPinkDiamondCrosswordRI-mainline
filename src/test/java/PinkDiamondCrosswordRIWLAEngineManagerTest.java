...
public class PinkDiamondCrosswordRIWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(PinkDiamondCrosswordRIWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/PinkDiamondCrosswordRIIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/PinkDiamondCrosswordRIIW/InitOutcome.xml").getDocumentElement();
